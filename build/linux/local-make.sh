...
then
  ...
  install -m 755 dist/processing-local work/processing
fi
...
javac -d bin -source 1.3 src/processing/core/*.java
...
CLASSPATH="../build/linux/work/lib/core.jar:../build/linux/work/lib/apple.jar:../build/linux/work/lib/antlr.jar:../build/linux/work/lib/oro.jar:../build/linux/work/lib/registry.jar"
...
javac -source 1.3 -classpath $CLASSPATH:../build/linux/work/classes -d ../build/linux/work/classes src/processing/app/*.java src/processing/app/preproc/*.java src/processing/app/syntax/*.java src/processing/app/tools/*.java src/antlr/*.java src/antlr/java/*.java
...
javac -source 1.3 -d bin src/processing/net/*.java
...
javac -source 1.3 -d bin src/processing/dxf/*.java
...
javac -source 1.3 -d bin src/processing/xml/*.java
